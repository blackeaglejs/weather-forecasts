...
class ForecastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forecast" do
    assert_difference("Forecast.count") do
      post forecasts_url, params: { forecast: { current_temperature: @forecast.current_temperature, high: @forecast.high, location_id: @forecast.location_id, low: @forecast.low, time: @forecast.time } }
    end
  ...
  test "should update forecast" do
    patch forecast_url(@forecast), params: { forecast: { current_temperature: @forecast.current_temperature, high: @forecast.high, location_id: @forecast.location_id, low: @forecast.low, time: @forecast.time } }
